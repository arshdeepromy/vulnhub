...
$row = array(
	...
	'Primary user UPN'          => 'csvtest.person@example.example',
	'Primary user email address' => 'csvtest.person@example.example',
...
$wpdb->delete( vh_table( 'people' ), array( 'email' => 'csvtest.person@example.example' ) );
