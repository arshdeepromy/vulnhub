...
**Origin scanned:** http://localhost:8093 (public edge: https://vulnhub.example.com via Cloudflare tunnel)
**Date:** 2026-09-09
...
Scanned the origin (`localhost:8093`). At `vulnhub.example.com` Cloudflare may already mask the Server
