...
|---|---|---|
| `browserpass.js`, `interact.js`, `probe.js`, `designaudit.js`, `elementorpass.js`, `dragpass.js`, `exportpass.js`, `lifecyclepass.js`, `ownerpass.js` | `romy` (administrator) at `wp-login.php` | `.admin_pass` |
| `boardpass.js`, `importpass.js`, `portaluser.js` | `romy.portal` (portal-only `vulnhub_admin`, no WordPress rights) | `.portal_test_pass` |
