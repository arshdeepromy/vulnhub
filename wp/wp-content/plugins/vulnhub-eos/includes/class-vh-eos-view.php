	...
	private static function workload( array $summary, array $args ): void {
		...
		<div class="vh-card vh-eos__workload">
			...
			<p class="vh-meta vh-eos__fynote">
				<?php esc_html_e( 'Quarters follow a financial year starting 1 April, and "overdue" is measured against the last day of the quarter named. The programme has this listed as an open item — if Bluecurrent\'s fiscal calendar differs, the overdue split moves with it.', 'vulnhub' ); ?>
			</p>
		</div>
		<?php
	}
