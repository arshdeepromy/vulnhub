...
final class VulnHub_Rules_Admin {
	...
	private static function asset_ver( string $rel ): string {
		$mtime = @filemtime( VULNHUB_RULES_DIR . $rel ); // phpcs:ignore WordPress.PHP.NoSilencedErrors.Discouraged

		return $mtime ? VULNHUB_RULES_VERSION . '.' . $mtime : VULNHUB_RULES_VERSION;
	}
	...
	public static function assets(): void {
		...
		wp_enqueue_style( 'vulnhub-rules', VULNHUB_RULES_URL . 'assets/rules.css', array( 'vulnhub-app' ), self::asset_ver( 'assets/rules.css' ) );
		wp_enqueue_script( 'vulnhub-rules', VULNHUB_RULES_URL . 'assets/rules.js', array(), self::asset_ver( 'assets/rules.js' ), true );
	}
